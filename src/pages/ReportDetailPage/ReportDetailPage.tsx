        ...
        <div className="flex-1 overflow-y-auto w-full pb-10 scrollbar-hide">
          ...
          <div className="px-4 mt-4 pb-4 flex flex-col gap-3">
            <button
              ...
              className="w-full h-[48px] rounded-[100px] border border-primary-300 text-primary-300 font-semibold text-[16px] flex items-center justify-center hover:bg-neutral-50 transition-colors"
            >
          ...
          <div className="px-4 pb-8">
            <button
              ...
              className="w-full h-[48px] rounded-[100px] border border-primary-300 text-primary-300 font-semibold text-[16px] flex items-center justify-center hover:bg-neutral-50 transition-colors disabled:opacity-50 disabled:border-neutral-200 disabled:text-neutral-400"
            >
